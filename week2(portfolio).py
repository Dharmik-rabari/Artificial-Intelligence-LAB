# -*- coding: utf-8 -*-
"""Week_2(Portfolio).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/18W_lbjVv-B9v9Tx-ftKZkbnUjpsbTtpD
"""
...
"""In this week's lab, We worked on implementing linear regression with the help of using gradient descent. And we also did built-in linear regression model from sckit-learn. We did the first part using the python, numpy and matplotlib and in this, we clculated the slop and intercept manyally and also updated it multiple times. This showed change in the vlaues and cost over time and that showed how gradient descent really works. Then after, we worked with california housing dataset and used machine learning workflow by loading, splitting, training and evalating the data of the model. Then we also used MSE, RMSE, MAE and R2 metrics to check the model performance and we also used dummy data to do some predictions."""
